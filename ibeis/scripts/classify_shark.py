...
def get_shark_labels_and_metadata(target_type=None, ibs=None, config=None):
    ...
    logger.info('Building labels for %r annotations from %r images' % (
...
def shark_svm():
    ...
    logger.info(pd.DataFrame(confusion, columns=[m for m in result.ds.target_names],
