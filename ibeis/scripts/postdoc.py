...
class VerifierExpt(DBInputs):
    ...
    def agg_results(VerifierExpt, task_key):
        ...
        improved = cmc_diff > 0
        logger.info('{} / {} datasets saw CMC improvement'.format(sum(improved),
                                                            len(cmc_diff)))
        ...
        improved = tpr_diff > 0
        logger.info('{} / {} datasets saw TPR improvement'.format(sum(improved),
                                                            len(tpr_diff)))
    ...
    def ranking_hyperparamm_search(self):
        ...
        logger.info('SO FAR: ')
        logger.info(ut.align(ut.repr4(ut.sort_dict(grid_output, 'vals'), precision=4), ':', pos=2))
    ...
    def measure_hard_cases(self, task_key):
        ...
        logger.info('With average hardness {}'.format(
        ...
        for (pred, real), group in failure_cases.groupby(('pred', 'real')):
            ...
            logger.info('Selected {} r({})-p({}) cases'.format(
