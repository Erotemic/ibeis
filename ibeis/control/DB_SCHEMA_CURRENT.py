"""
AUTOGENERATED ON 12:36:53 2018/04/26
AutogenCommandLine:
    python -m ibeis.control.DB_SCHEMA autogen_db_schema --force-incremental-db-update --write
    python -m ibeis.control.DB_SCHEMA autogen_db_schema --force-incremental-db-update --diff=1
