...
Notes:
    ...
    Also:
        ...
        Then go to
            ...
            https://github.com/Erotemic/ibeis/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/ibeis/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'ibeis')
...
# html_logo = '.static/ibeis.svg'
# html_favicon = '.static/ibeis.ico'
...
latex_documents = [
    (master_doc, 'ibeis.tex', 'ibeis Documentation',
     'Jon Crall Jason Parham', 'manual'),
]
...
man_pages = [
    (master_doc, 'ibeis', 'ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ibeis', 'ibeis Documentation',
     author, 'ibeis', 'One line description of project.',
     'Miscellaneous'),
]
